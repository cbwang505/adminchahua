...
function SWFLoad(swfu, loadSettings) {
    ...
    upload_url: dummyPath + "SWFUpload/upload.aspx",
        ...
        button_image_url: dummyPath + "swfupload/images/swfupload_uploadBtn.png",
        ...
        flash_url: dummyPath + "swfupload/swf/swfupload.swf",
...
function DelPic(fileInfo, swfObj) {
    ...
    var url = "../upload.aspx?cmd=del&f=" + fileInfo.Path + "&name=" + fileInfo.FileName + "&dt=" + new Date();
    //删除指定ServerData值
