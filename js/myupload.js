/**
 * Created by wangcb on 2015/8/11.
 */
/*
...
(function ($) {
    ...
    function myuploaderinit(srcelement) {
    ...
    $.fn.myuploader = function (option) {

        if (typeof(option) == "string") {
            var myuploaderinst = this.data("myuploader");

            if (myuploaderinst) {
                if ($.isFunction(myuploaderinst[option])) {
                    return myuploaderinst[option].apply(myuploaderinst, Array.prototype.slice.call(arguments, 1));
                }
            ...
            var data = this.data("myuploader");
            if (!data) {
                this.data("myuploader", new myuploaderinit(this));
            }
            this.data("myuploader").setdefault(option);

            this.data("myuploader").attachPlugin();
    ...
    $.extend(myuploaderinit.prototype, {
        attachPlugin: function () {
            var swfUploadSettings = {
                assume_success_timeout: this.mydefault.successTimeout,
                button_placeholder_id: $(this.mydefault.srcTarget).attr("id"),
                button_width: this.mydefault.width,
                button_height: this.mydefault.height,
                button_image_url:this.mydefault.button_image_url,
                button_text: null,
                button_text_style: null,
                button_text_top_padding: 0,
                button_text_left_padding: 0,
                button_action: (this.mydefault.multi ? SWFUpload.BUTTON_ACTION.SELECT_FILES : SWFUpload.BUTTON_ACTION.SELECT_FILE),
                button_disabled: false,
                button_cursor: (this.mydefault.buttonCursor == 'arrow' ? SWFUpload.CURSOR.ARROW : SWFUpload.CURSOR.HAND),
                button_window_mode: "window",
                debug: this.mydefault.debug,
                requeue_on_error: this.mydefault.requeueErrors,
                file_post_name: this.mydefault.fileObjName,
                file_size_limit: this.mydefault.fileSizeLimit,
                file_types: this.mydefault.fileTypeExts,
                file_types_description: this.mydefault.fileTypeDesc,
                file_queue_limit: this.mydefault.queueSizeLimit,
                file_upload_limit: this.mydefault.uploadLimit,
                flash_url: this.mydefault.swf,
                prevent_swf_caching: this.mydefault.preventCaching,
                post_params: this.mydefault.formData,
                upload_url: this.mydefault.destUrl,
                use_query_string: (this.mydefault.method == 'get'),

                // Event Handlers 
                file_dialog_complete_handler: this.mydefault.handlers.onDialogClose,
                file_dialog_start_handler: this.mydefault.handlers.onDialogOpen,
                file_queued_handler: this.mydefault.handlers.onSelect,
                file_queue_error_handler: this.mydefault.handlers.onSelectError,
                swfupload_loaded_handler: null,
                upload_complete_handler: this.mydefault.handlers.onUploadComplete,
                upload_error_handler: this.mydefault.handlers.onUploadError,
                upload_progress_handler: this.mydefault.handlers.onUploadProgress,
                upload_start_handler: this.mydefault.handlers.onUploadStart,
                upload_success_handler: this.mydefault.handlers.onUploadSuccess
            }

             this.initmtSWFuploader(swfUploadSettings);
            return this;

        },
        initmtSWFuploader:function(swfUploadSettings)
        {
            ...
            if (flashInstalled) {
                ...
                window['myuploader_' +$(this.mydefault.srcTarget).attr("id")] = new SWFUpload(swfUploadSettings);
                var swfuploadify = window['myuploader_' + $(this.mydefault.srcTarget).attr("id")];
                $(this.mydefault.srcTarget).data("SWFuploadInst",swfuploadify);
                ...
                $("#"+this.mydefault.uploadButtonId).unbind("click").bind("click",function(e){
                    swfuploadify.selectFiles();
                   e.preventDefault();
    ...
    $.fn.myuploader.constructor = myuploaderinit;
